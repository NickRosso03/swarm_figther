...
Rispetta esattamente il protocollo del prof (pacchetti binari su UDP),
con queste differenze/miglioramenti:
  - Il thread di ricezione usa select() con timeout, identico al prof
...
# ---------------------------------------------------------------------------
# Costanti di protocollo — identiche a dds.gd
# ---------------------------------------------------------------------------
...
class _MonitoredVariable:
    """Variabile thread-safe con supporto wait/notify (identica al prof)."""
...
class DDS(threading.Thread):
    ...
    # ------------------------------------------------------------------
    # Overload start() per accettare host/port opzionali (come il prof)
    # ------------------------------------------------------------------
