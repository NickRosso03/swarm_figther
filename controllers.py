...
Fedele all'interfaccia del prof:
    evaluate(delta_t, error)  ← errore già calcolato dal chiamante

Differenza rispetto alla versione del prof: non dipende da lib.system.basic
(Integrator e Derivator sono reimplementati inline), così il file è
autosufficiente nel nostro progetto.
"""
...
# ---------------------------------------------------------------------------
# Integrator e Derivator (dal prof, lib/system/basic.py)
# ---------------------------------------------------------------------------
